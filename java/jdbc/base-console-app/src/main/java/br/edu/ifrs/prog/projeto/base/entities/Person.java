...
/**
 *
 * @author diego create table person( id integer not null primary key
 * autoincrement, name varchar(100) not null, birth_date date not null, heigth
 * float not null, city_address_id integer not null references city );
 */
public class Person {
